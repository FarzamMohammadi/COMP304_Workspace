...
public class FarzamMohammadi_COMP304Sec002_Lab03_Ex01 extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_farzam_mohammadi__c_o_m_p304_sec002__lab03__ex01);
        ...
        private void _init() {
            ...
            findViewById(R.id.rightArrowKeyBtn).setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    FarzamMohammadi_COMP304Sec002_Lab03_Ex01.this._drawLineRight();
                    return true;
                }
            });
            findViewById(R.id.upArrowKeyBtn).setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    FarzamMohammadi_COMP304Sec002_Lab03_Ex01.this._drawLineUp();
                    return true;
                }
            });
            findViewById(R.id.leftArrowKeyBtn).setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    FarzamMohammadi_COMP304Sec002_Lab03_Ex01.this._drawLineLeft();
                    return true;
                }
            });
            findViewById(R.id.downArrowKeyBtn).setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    FarzamMohammadi_COMP304Sec002_Lab03_Ex01.this._drawLineDown();
                    return true;
                }
            });
            ...
            findViewById(R.id.clearCanvasBtn).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    FarzamMohammadi_COMP304Sec002_Lab03_Ex01.this._clearCanvas();
                }
            });
                ...
                public void onCheckedChanged(RadioGroup radioGroup, int idChecked) {
                    switch (idChecked) {
                        case R.id.redLineColorRadioBtn:
                            FarzamMohammadi_COMP304Sec002_Lab03_Ex01.this._paint.setColor(Color.RED);
                            break;
                        case R.id.cyanLineColorRadioBtn:
                            FarzamMohammadi_COMP304Sec002_Lab03_Ex01.this._paint.setColor(Color.YELLOW);
                            break;
                        case R.id.yellowLineColorRadioBtn:
                            FarzamMohammadi_COMP304Sec002_Lab03_Ex01.this._paint.setColor(Color.CYAN);
                            break;
                    }
                }
            });
            ...
            lineThicknessSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                    FarzamMohammadi_COMP304Sec002_Lab03_Ex01.this._paint.setStrokeWidth(Integer.parseInt(getResources().getStringArray(R.array.ex1_line_thickness_array)[position]));
                }
